...
We useRouteMatch because it allows the user to gain access to the match data of a url without needing to render a route.

2. How would you explain form validation to someone who has never programmed before?

Validation is a test that checks information used as input matches the criteria needed for a valid response.

3. In 1-2 sentences, define end to end testing. 

End to end testing tests to see if the flow of an application from start to end is working as expected.
